...
echo ""
echo "--- Запуск Codex ---"
echo "Скопируй команду целиком (она содержит -C $DEMO_DIR — фиксирует workdir,"
echo "иначе codex возьмёт текущую папку и начнёт сканить твой home):"
echo ""
echo "--- Команда 1: что за репо и какие плагины (русский ответ) ---"
echo ""
echo "  HOME=$CLEAN_HOME codex exec --skip-git-repo-check -C $DEMO_DIR \\"
