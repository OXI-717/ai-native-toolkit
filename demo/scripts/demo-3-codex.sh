...
echo ""
echo "--- Запуск Codex ---"
echo "Скопируй команду целиком — она содержит cd и -C (двойная защита от"
echo "ошибки workdir: иначе codex может взять текущую папку и сканить твой home):"
echo ""
echo "--- Команда 1: что за репо и какие плагины (русский ответ) ---"
echo ""
echo "  cd $DEMO_DIR && HOME=$CLEAN_HOME codex exec --skip-git-repo-check -C $DEMO_DIR \\"
