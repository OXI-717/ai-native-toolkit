...
def ensure_venv_and_run():
    ...
    if not venv_dir.exists():
        ...
        print(f"✅ Environment ready! All dependencies isolated in {venv_dir}")
    ...
    if not in_venv:
        ...
        if os.name == 'nt':
            print(f"   Or activate: {venv_dir / 'Scripts' / 'activate.bat'}")
        else:
            print(f"   Or activate: source {venv_dir / 'bin' / 'activate'}")
