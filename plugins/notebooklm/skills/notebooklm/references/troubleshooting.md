...
cp ~/.local/share/notebooklm/data/library.json library.backup.json

# Reset library
rm ~/.local/share/notebooklm/data/library.json
...
```bash
# Check disk usage
df -h ~/.local/share/notebooklm/data/
...
if [ -f ~/.local/share/notebooklm/data/library.json ]; then
    cp ~/.local/share/notebooklm/data/library.json ~/library.backup.json
fi
...
# Remove venv
rm -rf ~/.local/share/notebooklm/.venv
...
if [ -f ~/library.backup.json ]; then
    mkdir -p ~/.local/share/notebooklm/data/
    cp ~/library.backup.json ~/.local/share/notebooklm/data/library.json
fi
```
...
ls -la ~/.local/share/notebooklm/data/
```
